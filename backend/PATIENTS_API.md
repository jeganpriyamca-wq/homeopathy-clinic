...
DOB search: enter a full date as DD/MM/YYYY or YYYY-MM-DD in the existing search box. Birth dates match exactly; invalid or partial dates are not interpreted as dates. Example: /api/patients?q=1976-06-15 finds Demo Patient 01 from the demo seed data.
